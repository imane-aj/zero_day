...
export default function Chat() {
  ...
  return (
    ...
    <div className='mb-6 flex flex-col md:flex-row md:justify-between'>
        <h3 className='my-3 w-[fit-content] inline-block rounded  bg-blite px-6 pb-2 pt-2.5 text-bgray font-medium'>Chats</h3>
        <form>   
    ...
    <ChatList searchQuery={searchQuery} dispatch={dispatch}/>
    </>
  )
}
