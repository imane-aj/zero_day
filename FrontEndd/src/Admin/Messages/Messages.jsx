...
export default function Messages() {
  ...
  return (
    <>
        ...
        <h3 className='my-3 w-[fit-content] inline-block rounded bg-blite px-6 pb-2 pt-2.5 text-blue font-medium'>Messages</h3>
        <form>   
        ...
        <MessagesList searchQuery={searchQuery} dispatch={dispatch}/>
    </>
  )
}
