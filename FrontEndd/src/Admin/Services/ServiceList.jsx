...
import { deleteService, services } from '../../Redux/ServiceSlice';
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          dispatch(deleteService(id)).then((res) => {
            ...
            if (res.type === 'service/deleteService/fulfilled') {
          ...
          {dataToDisplay?.map((val,idx)=>(
              ...
              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <div className="flex items-center space-x-3.5">
                  ...
                  <Link className="hover:text-primary" to = {`edit_service/${val.id}`}>
