...
import { ShowService, storeService, updateService } from '../../Redux/ServiceSlice';
...
export default function NewService() {
    ...
    const handleSave = (e)=>{
        ...
        if(id){
            dispatch(updateService({id,formData})).then((res) => {
                if (res.type === 'service/updateService/fulfilled') {
                  navigate('/admin/services')
                  Swal.fire('Success', 'This service was updated succefuly', 'success');
                }
              });
            }else{
                dispatch(storeService(formData)).then((res) => {
                    console.log(res)
                    if (res.type === 'service/storeService/fulfilled') {
                      navigate('/admin/services')
