...
import {  DriversT, Search_driver } from '../../../Redux/DriverSlice';
const DriverList = () => {
  ...
  const driver = useSelector((state) => state.driver.dataT)
  ...
  useEffect(() => {
    dispatch(DriversT(`${url}drivers?page=1`));
  }, [dispatch]);

  const handlePagination = (url) => {
    console.log('Pagination URL:', url);
    dispatch(DriversT(url));
  };
