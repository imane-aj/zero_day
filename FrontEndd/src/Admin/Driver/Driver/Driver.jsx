...
import { Search_driver } from '../../../Redux/DriverSlice';
import DriverList from './DriverList';
import DriversDemande from './DriversDemande';
...
export default function Driver() {
  ...
  return (
    <>
      ...
      <DriverList searchQuery={searchQuery} dispatch={dispatch}/>
      <DriversDemande searchQuery={searchQuery} dispatch={dispatch} />
    </>
  )
}
