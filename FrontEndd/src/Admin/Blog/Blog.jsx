...
import { handleSearch } from '../../Redux/BlogSlice';
...
export default function Blog() {
  ...
  return (
    ...
    <div className='mb-6 flex flex-col md:flex-row md:justify-between'>
        <Link to = 'nouvelle_article' className='my-3 w-[fit-content] inline-block rounded bg-blite px-6 pb-2 pt-2.5 text-bgray hover:text-white font-medium hover:bg-blue transition-all duration-200'
        >
            <span>
            <i class="fa-solid fa-plus"></i> Ajouter une article
    ...
    <BlogList searchQuery={searchQuery} dispatch={dispatch}/>
    </>
  )
}
