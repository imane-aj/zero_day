...
import { SearchClients } from '../../Redux/ClientSlice';
  ...
  return (
    <Fragment>
      <div className='mb-10 flex flex-col md:flex-row md:justify-between'>
        <h3 className='my-3 w-[fit-content] inline-block rounded bg-blite px-6 pb-2 pt-2.5 text-blue font-medium'>Clients</h3>
      ...
      <ClientsList searchQuery={searchQuery} dispatch={dispatch}/>
    </Fragment>
  )
}
