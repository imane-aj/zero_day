...
import { createLongTrip } from '../../Redux/RequestSlice';
import { useNavigate } from 'react-router-dom';
import Swal from 'sweetalert2'
import { Button } from "@chakra-ui/button";
import { createGlobalStyle } from 'styled-components';
import globe from '../Pages/components/img/globe.svg';
// import './components/css/styleconfirmation.css'
const LongVoyageForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append('longtrip_id', id);


    // for (const pair of formData.entries()) {
    //   console.log(pair[0] + ": " + pair[1]);
    // }
    dispatch(createLongTrip(formData)).then((res) => {
      if (res.type === 'Request/createLongTrip/fulfilled') {
        navigate('/')
              ...
              <div class="min-h-screen bg-gray-100 p-0 sm:p-12">
                ...
                <div className="text-center mb-7 d-flex flex-column align-items-center">
                  ...
                  <svg
                    ...
                    <h3 class="text-2xl font-bold mb-8">Reservez votre longue voyage</h3>
                  </div>
